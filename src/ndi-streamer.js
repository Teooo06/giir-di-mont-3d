...
this.ndiRenderer.toneMappingExposure = 1.12; // match main renderer for consistent NDI output (Closes #149)
this.ndiRenderer.shadowMap.enabled = true;
this.ndiRenderer.shadowMap.type = THREE.PCFSoftShadowMap; // soft shadows for broadcast quality
